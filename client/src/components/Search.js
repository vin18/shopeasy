    ...
    <div className="flex justify-center mb-4 md:mb-0 items-center">
      <div className="ml-5 xl:w-96">
        <form
          ...
          className="input-group relative flex items-center w-full"
        >
          <input
            type="search"
          ...
          />
          <button
            className="btn px-6 py-2.5 bg-indigo-800 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-indigo-700 hover:shadow-lg focus:bg-indigo-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-indigo-800 active:shadow-lg transition duration-150 ease-in-out flex items-center"
            type="button"
            id="button-addon2"
